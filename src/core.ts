...
import { createCharacter, downloadAsset, getFlowState, listAssets, runEdit, runGeneration } from "./flow.js";
...
export const jobView = ({ id, status, params, files, credits, progress, error }: Job) => ({
  id,
  status,
